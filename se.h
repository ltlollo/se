...
int match(uint8_t *, uint8_t *, uint8_t *, char *, intptr_t);
struct colored_world match_word(uint8_t *, uint8_t *, uint8_t *);
...
void convert_line_external(struct line *, struct document *);
