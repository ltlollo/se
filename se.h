...
struct extern_line * line_internal_reserve(struct line *, size_t, struct document *);
struct extern_line * line_external_reserve(struct line *, size_t, struct document *);
struct extern_line * line_reserve(struct line *, size_t, struct document *);
void merge_lines(struct line_metadata *, struct line_metadata *, struct document *);
void diffstack_undo_line_split(uint8_t *, uint8_t *, struct document *, struct window *);
void diffstack_undo_chars_del(uint8_t *, uint8_t *, struct document *, struct window *);
void diffstack_undo_chars_add(uint8_t *, uint8_t *, struct document *, struct window *);
void diffstack_insert_chars_del(struct diffstack **, uint8_t *, size_t, size_t, size_t);
uint8_t * diffstack_curr_mvback(uint8_t *);
int diffstack_undo(struct diffstack *, struct document *, struct window *);
...
void diff_line_merge(struct diffstack **, size_t, size_t, struct document **, struct window *);
void diff_line_split(struct diffstack **, size_t, size_t, struct document **, struct window *);
void diff_line_insert(struct diffstack **, size_t, struct line_metadata *, struct document *, struct window *, uint8_t *, size_t);
void diff_line_remove(struct diffstack **, size_t, struct line_metadata *, struct document *, struct window *, size_t);
