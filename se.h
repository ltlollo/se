...
void line_insert(size_t, struct line_metadata *, struct document *, struct window *, uint8_t *, size_t);
void line_remove(size_t, struct line_metadata *, struct document *, struct window *, size_t);
